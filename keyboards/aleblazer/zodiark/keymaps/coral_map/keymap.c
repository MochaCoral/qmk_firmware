...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = LAYOUT(
      ...
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,  KC_INS,                       KC_PGUP,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS,
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  KC_DEL,                       KC_PGDN,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_HOME, KC_MUTE,      RGB_TOG, KC_END,KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
      KC_ADJUST, KC_LALT, KC_LGUI, KC_GRV, KC_LOWER,  KC_SPC,   KC_LBRC,    KC_RBRC,   KC_BKSP,  KC_RAISE,    KC_BSLS, KC_DOWN, KC_UP,   KC_RGHT
    ),
	...
	[_RAISE] = LAYOUT(
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                           KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
      KC_PSLS, KC_P7, KC_P8, KC_P9, KC_NLCK, _______, _______,                    _______, _______, KC_PSLS, KC_P7, KC_P8, KC_P9, KC_F12,
      KC_CAPS, KC_P4, KC_P5, KC_P6, KC_NLCK, _______, _______,                    _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_NLCK,
      _______, KC_P1, KC_P2, KC_P3, _______, _______, _______, _______,  _______, _______, _______, _______, KC_P1, KC_P2, KC_P3, _______,
      _______, KC_P0, KC_PDOT, KC_PENT, _______,    _______,   _______,  _______,    _______,    _______, KC_P0, KC_PDOT, KC_PENT, _______
      ),
	...
	[_ADJUST] = LAYOUT(
      ...
      _______, _______, _______, KC_B,  KC_P,  KC_E, _______,                   _______, _______, RGB_TOG, _______, _______, _______, _______,
      ...
      _______, _______, _______, _______, _______,      LCTL(Z),     RCS(KC_Z), _______,     _______,      RGB_RMOD, RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD
      )
